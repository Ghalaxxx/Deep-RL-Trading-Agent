"""Stable-Baselines3 PPO model factory."""
...
def create_ppo_model(
    ...
    """Create a PPO model from a project config dictionary."""

    if PPO is None:
        raise ImportError("stable-baselines3 and torch are required to train PPO.")
